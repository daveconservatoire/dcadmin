...
/**
 * This is the model class for table "PlaylistItem".
 *
 * The followings are the available columns in table 'PlaylistItem':
 * @property integer $id
...
class PlaylistItem extends CActiveRecord
{
	 ...
	 * @return PlaylistItem the static model class
	 */
